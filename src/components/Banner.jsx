...
const Banner = () => {
  return (
    <div className='h-[500px] relative flex items-center' style={{backgroundImage: `url(${banner})`, backgroundSize:'cover', backgroundPosition: 'center', backgroundAttachment: 'fixed'}}>
      <div className='bg-black inset-0 opacity-65 absolute '></div>
      <div className='text-white flex-col flex items-center justify-center   text-center  max-w-7xl mx-auto z-20'>
